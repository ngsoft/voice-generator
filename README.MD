...
An installation of FFMPEG might be required
...
**POST** `/voice/speak/{voice}` (you can use one of the resolved `{voiceUri}` in the voice list)
...
**response** `audio/x-wave|audio/x-mpeg` 16 bits file to be played (wav or mp3)
